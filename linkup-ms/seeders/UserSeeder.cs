    ...
    public static class UserSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                ...
                new User {Name = "alice johnson", Email = "alice.johnson@example.com", IsConfirmed = true, Password = "riwi123", PhoneNumber = "3456789012", CreatedAt = new DateTime(2024, 4, 5), SectorId = 4, RoleId = 2 },
                ...
                new User {Name = "edward davis", Email = "edward.davis@example.com", IsConfirmed = true, Password = "riwi123", PhoneNumber = "7890123456", CreatedAt = new DateTime(2024, 8, 15), SectorId = 5, RoleId = 2 },
                ...
                new User {Name = "george fisher", Email = "george.fisher@example.com", IsConfirmed = true, Password = "riwi123", PhoneNumber = "9012345678", CreatedAt = new DateTime(2024, 10, 5), SectorId = 5, RoleId = 2 },
