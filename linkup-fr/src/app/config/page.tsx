...
export default function DashboardView(){
    ...
    return (
        <Route>
            <main>
                <DashboardLayout section={<SectionProfile isDarkMode={DarkMode} language={language}/>} language={language} titleView={titleView} subtitle={subtitle} isDarkMode={DarkMode}/>
            </main>
        </Route>
    );
};