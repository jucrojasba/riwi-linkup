...
export default function DashboardView(){
    ...
    return (
        <main>
            <DashboardLayout section={<SectionDashboard isDarkMode={DarkMode} language={language}/>} titleView='Dashboard' subtitle="General Information"  path="dashboard" language={language}/>
        </main>
    );
}
