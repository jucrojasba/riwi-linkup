...
const LogInForm:React.FC=()=>{
    return(
        <Box component='form'onSubmit={()=>{console.log("ok")}} sx={{display:'flex',flexDirection:'column',gap:'var(--padding-big)', alignItems:'center',width:'20%'}}>
            ...
            <Box component={'span'}>
                <Typography variant="body1" sx={{color:'var(--secondary-color)',fontFamily:'var(--main-font)'}}> Don't have an account? <CustomLink text="Sign up" href="/register"></CustomLink></Typography>
            </Box>
        </Box>
    );
  };
